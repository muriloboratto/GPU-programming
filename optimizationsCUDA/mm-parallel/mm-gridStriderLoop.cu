...
@(#)Usage:         
 (*) Hotocompile:   nvcc mm-gridStriderLoop.cu -o mm-gridStriderLoop -Xcompiler -fopenmp -O3
 (*) Hotoexecute:  ./mm-gridStriderLoop  <size> <blockSize>  
